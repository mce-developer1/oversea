$(document).ready(function() {
  ...
  if ($container.hasClass('article-student-incidents')) {
    ...
    $container.find('.article-body .navbar .btn-edit').on('click', function(e) {
      var $upload = $('.modal-student-incident-edit .file-upload');
      destroyDropZone();
      ...
      $('.modal-student-incident-edit .file-upload').on('click', '.btn-delete', function(e) {
        var $file = $(this).closest('.file-preview');
        ...
        $('.modal-student-incident-edit .btn-primary').on('click', function(e) {
          $('.modal-file-remove-confirmation').modal('hide');
          removeAllDropZoneFiles();
        });
        $('.modal-file-remove-confirmation').modal('show');
      ...
      $('.modal-student-incident-edit').on('keydown', function(e) {
        if (e.which == 27) {
          if (window._pageDirty) {
            e.which = Number.NaN;
            e.stopPropagation();
            showCancelUploadConfirmationModal(function() {
              $('.modal-student-incident-edit').modal('hide');
              removeAllDropZoneFiles();
              dropzone.destroy();
            });
          } else {
      ...
      $('.modal-student-incident-edit .btn-close').on('click', function(e) {
        if (window._pageDirty) {
          e.stopPropagation();
          showCancelUploadConfirmationModal(function() {
            $('.modal-student-incident-edit').modal('hide');
  ...
  if ($container.hasClass('article-incidents-report')) {
    $('#selFilter').on('changed.bs.select', function (e) {
      if ($('#selFilter').selectpicker('val') === 'Period') {
        $container.find('.form-filters .form-group-term').addClass('d-none');
        $container.find('.form-filters .form-group-period').removeClass('d-none');
      } else {
        $container.find('.form-filters .form-group-period').addClass('d-none');
        $container.find('.form-filters .form-group-term').removeClass('d-none');
      }
    });
